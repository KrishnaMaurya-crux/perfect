 ...
 *
 * NOTE: This is a thin wrapper that re-uses the same extraction logic
 * as the summary tool. Kept separate for modularity / future divergence.
 */
